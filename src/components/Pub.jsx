        ...
        <div style={{backgroundImage: 'url(/img/car2.gif)', position: 'relative', backgroundSize: 'cover', backgroundPosition: 'center'}} className="bg-gradient-to-r from-primary to-black rounded-2xl p-5 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-gray-200 mb-2">Get 20% Off Your First Rental</p>
              <p className="text-sm text-gray-300">Limited Time Offer - Don't Miss Out!</p>
            </div>

            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-white mb-2">20%</div>
                <p className="text-gray-200 text-sm">Discount on First Booking</p>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-white mb-2">24/7</div>
                <p className="text-gray-200 text-sm">Customer Support</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <Link 
                to="/products" 
                className="inline-block bg-primary text-white px-8 py-3 rounded-lg font-bold text-sm hover:bg-darkgrey transition-colors duration-300"
              >
                Book Now
              </Link>
            </div>
